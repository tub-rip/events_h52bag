...
To overcome memory limitations for large data files, multiple ouptut ROSBags may be generated by defining a limit (500M default) on the number of events in each bag.
